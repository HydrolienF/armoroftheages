package org.dawnoftime.armoroftheages.set.todo;/*
												 ...
												 * this.ribbonLeft.texOffs(10, 16).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 10.0F, 0.0F, 0.0F,
												 * false);
												 ...
												 * this.ribbonRight.texOffs(10, 16).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 10.0F, 0.0F, 0.0F,
												 * true);
												 ...
												 * ribbonRightNode.texOffs(0, 5).addBox(-2.1F, -2.1F, -0.032F, 2.0F, 2.0F, 2.0F, 0.1F,
												 * true);
												 ...
												 * headLayerRight_r1.texOffs(98, 0).addBox(0.05F, 0.05F, 0.04F, 3.0F, 10.0F, 4.0F, 0.05F,
												 * true);
												 ...
												 * headLayerLeft_r1.texOffs(98, 0).addBox(-3.05F, 0.05F, 0.04F, 3.0F, 10.0F, 4.0F, 0.05F,
												 * false);
												 * this.earRight = new ModelRenderer(this);
												 * this.earRight.setPos(-4.0F, -7.0F, -0.5F);
												 * this.earRight.texOffs(0, 0).addBox(-0.7342F, -5.0323F, -1.0764F, 2.0F, 4.0F, 1.0F, 0.0F,
												 * false);
												 * this.earRight.texOffs(0, 16).addBox(-3.2342F, -10.5323F, -0.5764F, 5.0F, 10.0F, 0.0F,
												 * 0.0F, false);
												 * this.earLeft = new ModelRenderer(this);
												 * this.earLeft.setPos(4.0F, -7.0F, -0.5F);
												 * this.earLeft.texOffs(0, 0).addBox(-1.2658F, -5.0323F, -1.0764F, 2.0F, 4.0F, 1.0F, 0.0F,
												 * true);
												 * this.earLeft.texOffs(0, 16).addBox(-1.7658F, -10.5323F, -0.5764F, 5.0F, 10.0F, 0.0F,
												 * 0.0F, true);
												 * 
												 * if(isSteve){
												 ...
												 * this.rightArm.texOffs(112, 48).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F,
												 * false);
												 * this.rightArm.texOffs(0, 26).addBox(-3.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, -0.2F,
												 * false);
												 * shoulderRight.setPos(-2.25F, -0.75F, 0.0F);
												 * 
												 * this.leftArm.setPos(5.0F, 2.0F, 0.0F);
												 * this.leftArm.texOffs(112, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F,
												 * false);
												 ...
												 * 
												 * this.rightArm.setPos(-5.0F, 2.0F, 0.0F);
												 * this.rightArm.texOffs(112, 48).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, 0.25F,
												 * false);
												 * this.rightArm.texOffs(0, 26).addBox(-2.5F, -2.5F, -2.5F, 4.0F, 13.0F, 5.0F, -0.2F,
												 * false);
												 * shoulderRight = new ModelRenderer(this);
												 * shoulderRight.setPos(-1.25F, -0.75F, 0.0F);
												 * 
												 * this.leftArm.setPos(5.0F, 2.0F, 0.0F);
												 * this.leftArm.texOffs(112, 48).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, 0.25F,
												 * false);
												 ...
												 * shoulderRight.texOffs(112, 0).addBox(-1.75F, -2.0F, -2.5F, 3.0F, 5.0F, 5.0F, 0.05F,
												 * false);
												 * shoulderRight.texOffs(25, 0).addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
												 * shoulderRight.texOffs(18, 16).addBox(-3.0F, -6.0F, -3.0F, 4.0F, 9.0F, 6.0F, -0.2F,
												 * false);
												 * 
												 ...
												 * this.ribbonLegs.texOffs(14, 16).addBox(-1.5F, 0.0F, -0.25F, 3.0F, 6.0F, 0.0F, 0.0F,
												 * false);
												 * 
												 * this.leftLeg = new ModelRenderer(this);
												 * this.leftLeg.setPos(1.9F, 12.0F, 0.0F);
												 * this.leftLeg.texOffs(112, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F,
												 * false);
												 ...
												 * layerLegLeft.texOffs(108, 18).addBox(-0.75F, -2.25F, -2.5F, 2.0F, 4.0F, 5.0F, 0.15F,
												 * true);
												 * 
												 * this.rightLeg = new ModelRenderer(this);
												 * this.rightLeg.setPos(-1.9F, 12.0F, 0.0F);
												 * this.rightLeg.texOffs(112, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.25F,
												 * false);
												 * this.rightLeg.texOffs(38, 32).addBox(-2.6F, 0.4F, -2.5F, 5.0F, 5.0F, 5.0F, -0.05F,
												 * false);
												 ...
												 * layerLegRight.texOffs(108, 18).addBox(-1.25F, -2.25F, -2.5F, 2.0F, 4.0F, 5.0F, 0.15F,
												 * false);
												 * 
												 ...
												 * "slim".equals(((AbstractClientPlayerEntity) entityIn).getModelName())){
												 ...
												 * this.crossA.y = getOrbitalY(8.5F + 2 * sinPI((ageInTicks + 10) / 30.0F), -0.5F,
												 * ageInTicks);
												 * this.crossB.x = getOrbitalX(8.0F + 2 * sinPI(ageInTicks / 70.0F), 0.45F, ageInTicks+ 5);
												 * this.crossB.y = getOrbitalY(8.0F + 2 * sinPI((ageInTicks + 10) / 40.0F), 0.45F,
												 * ageInTicks + 25);
												 * this.crossC.x = getOrbitalX(9.0F + 2 * sinPI((ageInTicks + 25) / 30.0F), 0.55F,
												 * ageInTicks+ 25);
												 * this.crossC.y = getOrbitalY(9.0F + 2 * sinPI((ageInTicks + 5) / 50.0F), 0.55F, ageInTicks
												 * + 30);
												 * this.crossD.x = getOrbitalX(8.0F + 2 * sinPI((ageInTicks + 30) / 80.0F), 0.42F,
												 * ageInTicks + 20);
												 * this.crossD.y = getOrbitalY(8.0F + 2 * sinPI(ageInTicks / 50.0F), 0.42F, ageInTicks +
												 * 20);
												 * break;
												 * 
												 * case LEGS:
												 * this.ribbonLegs.xRot = -Math.abs(0.05F + 1.02F * this.rightLeg.xRot) + 0.05F * (1 +
												 * sinPI(ageInTicks / 40.0F));
												 * break;
												 * 
												 * default:
												 * break;
