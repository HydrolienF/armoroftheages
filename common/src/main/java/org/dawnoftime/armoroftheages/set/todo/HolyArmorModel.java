package org.dawnoftime.armoroftheages.set.todo;/*
												 ...
												 * this.chestEffectBigRotated.texOffs(90, 31).addBox(-9.5F, -9.5F, 0.0F, 19, 19, 0, 0.0F,
												 * false);
												 ...
												 * this.chestEffectMiddle.texOffs(0, 63).addBox(-8.5F, -8.5F, 0.01F, 17, 17, 0, 0.0F,
												 * false);
												 * this.chestEffectMiddleRotated = new ModelRenderer(this);
												 * this.chestEffectMiddleRotated.setPos(0.0F, -2.5F, 8.0F);
												 * this.chestEffectMiddleRotated.texOffs(0, 80).addBox(-6.5F, -6.5F, 0.0F, 13, 13, 0, 0.0F,
												 * false);
												 ...
												 * this.chestEffectSmallRotated.texOffs(101, 50).addBox(-4.5F, -4.5F, 0.01F, 9, 9, 0, 0.0F,
												 * false);
												 ...
												 * this.armRightEffectRotated.texOffs(34, 56).addBox(0.0F, -3.5F, -3.5F, 0, 7, 7, 0.01F,
												 * true);
												 ...
												 * this.armLeftEffectRotated.texOffs(34, 56).addBox(0.0F, -3.5F, -3.5F, 0, 7, 7, 0.01F,
												 * false);
												 ...
												 * this.armorLegLeft.texOffs(63, 51).addBox(-1.2598F, -0.1375F, -3.1F, 4, 3, 6, -0.05F,
												 * false);
												 ...
												 * this.armorLegRight.texOffs(63, 51).addBox(-2.7402F, -0.1375F, -3.1F, 4, 3, 6, -0.05F,
												 * true);
												 * 
												 * this.body = this.chest;
