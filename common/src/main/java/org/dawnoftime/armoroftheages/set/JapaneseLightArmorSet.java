// package org.dawnoftime.armoroftheages.set.japanese_light_armor;
...
// public JapaneseLightArmorSet(String id) { super(id); }
...
// CubeListBuilder.create().texOffs(26, 16).addBox(-4.0F, -6.5F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.4F)),
// PartPose.offset(0.0F, 0.0F, 0.0F));
// head.addOrReplaceChild("knotBase",
// CubeListBuilder.create().texOffs(56, 9).addBox(2.9F, -4.9F, 3.7F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.4F)),
// PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.785F));
// head.addOrReplaceChild("ribbonA",
// CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
// PartPose.offsetAndRotation(0.0F, -5.0F, 4.2F, 0.35F, 0.0F, 0.0F));
// head.addOrReplaceChild("ribbonB",
// CubeListBuilder.create().texOffs(60, 0).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
...
// @Override
// public LayerDefinition getLayer(MeshDefinition mesh, EquipmentSlot slot) { return LayerDefinition.create(mesh, 64, 32); }
