// package org.dawnoftime.armoroftheages.util;
...
// public static final Component TOOLTIP_HOLD_SHIFT = Component.translatable("tooltip." + MOD_ID + ".hold_key")
// .withStyle(ChatFormatting.GRAY).append(Component.translatable("tooltip." + MOD_ID + ".shift").withStyle(ChatFormatting.AQUA));
