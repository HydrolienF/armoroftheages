...
// builderIn.comment("----------------------------------------|| Armor settings ||---------------------------------------")
// .push(ARMOR_MATERIAL_CATEGORY);
...
// private ArmorConfig(final ForgeConfigSpec.Builder builderIn, String armorSet, int durability, int helmetDef, int chestDef,
// int legsDef, int feetDef, int enchantability, double toughness) {
// builderIn.push(armorSet);
// this.durability = builderIn.comment(
// "DurabilityFactor is multiplied with a value that depends on the armor part (between 11 and 16) to get the total durability :")
// .defineInRange(armorSet + "_durability_factor", durability, 1, 1000);
...
// this.enchantability = builderIn.comment("This armor's enchantability :").defineInRange(armorSet + "_enchantability",
// enchantability, 1, 100);
// this.toughness = builderIn.comment("This armor's toughness :").defineInRange(armorSet + "_toughness", toughness, 0.0D, 100.0D);
// builderIn.pop();
// }

// public Supplier<Integer> durabilitySupplier() { return this.durability::get; }

// public Supplier<Integer> helmetDefSupplier() { return this.helmetDef::get; }

// public Supplier<Integer> chestDefSupplier() { return this.chestDef::get; }

// public Supplier<Integer> legsDefSupplier() { return this.legsDef::get; }

// public Supplier<Integer> feetDefSupplier() { return this.feetDef::get; }

// public Supplier<Integer> enchantabilitySupplier() { return this.enchantability::get; }

// public Supplier<Float> toughnessSupplier() { return () -> this.toughness.get().floatValue(); }
// }
// }
