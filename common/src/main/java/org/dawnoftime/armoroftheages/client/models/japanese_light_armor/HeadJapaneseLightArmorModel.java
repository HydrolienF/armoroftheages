...
public class HeadJapaneseLightArmorModel<T extends LivingEntity> extends ArmorModel<T> {
    ...
    public HeadJapaneseLightArmorModel(ModelPart root) {
        super(root);
    ...
    @Override
    public ArmorModel<LivingEntity> create(ModelPart root) {
        return new HeadJapaneseLightArmorModel<>(root);
    }

    public static LayerDefinition createLayerDefinition() {
        // TODO handle the scale !
        MeshDefinition meshdefinition = templateLayerDefinition(CubeDeformation.NONE, 1.0F);
        ...
        head.addOrReplaceChild("knotBase", CubeListBuilder.create().texOffs(56, 9).addBox(2.9F, -4.9F, 3.7F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.4F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.785F));
        head.addOrReplaceChild("ribbonA", CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 7.0F, 0.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, -5.0F, 4.2F, 0.35F, 0.0F, 0.0F));
        head.addOrReplaceChild("ribbonB", CubeListBuilder.create().texOffs(60, 0).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 7.0F, 0.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0.0F, -5.0F, 4.2F, 0.175F, 0.0F, 0.0F));
