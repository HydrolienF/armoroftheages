...
public class ChestJapaneseLightArmorModel<T extends LivingEntity> extends ArmorModel<T> {
    ...
    public static LayerDefinition createLayerDefinition() {
        ...
        root.addOrReplaceChild("right_arm", CubeListBuilder.create()
                        ...
                        .texOffs(12, 16).addBox(-3.5F, 3.0F, -2.5F, 2, 5, 5, new CubeDeformation(0.2F)).mirror(false),
                PartPose.offset(-5.0F, 2.0F, 0.0F));
        root.addOrReplaceChild("left_arm", CubeListBuilder.create()
                        .texOffs(24, 0).addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, new CubeDeformation(0.3F)).mirror(false)
    ...
    public static LayerDefinition createSlimLayerDefinition() {
        ...
        root.addOrReplaceChild("right_arm", CubeListBuilder.create()
                        ...
                        .texOffs(12, 16).addBox(-2.5F, 3.0F, -2.5F, 2, 5, 5, new CubeDeformation(0.1F)).mirror(false),
                PartPose.offset(-5.0F, 2.5F, 0.0F));
        root.addOrReplaceChild("left_arm", CubeListBuilder.create()
                        .texOffs(24, 0).addBox(-1.0F, -2.0F, -2.0F, 3, 12, 4, new CubeDeformation(0.3F)).mirror(false)
