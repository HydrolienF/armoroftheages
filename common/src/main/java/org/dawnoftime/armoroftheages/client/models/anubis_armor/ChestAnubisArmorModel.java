...
public class ChestAnubisArmorModel<T extends LivingEntity> extends ArmorModel<T> {
    ...
    public static LayerDefinition createSlimLayerDefinition() {
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create()
                        .texOffs(104, 48).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F))
                        .texOffs(70, 0).addBox(-4.5F, -0.5F, -2.5F, 9.0F, 13.0F, 5.0F, new CubeDeformation(-0.22F))
                        .texOffs(-6, 52).addBox(-4.5F, -0.45F, -2.5F, 9.0F, 0.0F, 6.0F, CubeDeformation.NONE),
                PartPose.ZERO);

        body.addOrReplaceChild("chest_back", CubeListBuilder.create()
                        .texOffs(20, 31).addBox(-3.5F, -6.5F, -1.7F, 7.0F, 12.0F, 2.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(0.0F, 6.2F, 2.5F, -0.0873F, 0.0F, 0.0F));

        body.addOrReplaceChild("collar_front", CubeListBuilder.create()
                        .texOffs(-5, 58).addBox(-4.5F, 0.0F, -5.0F, 9.0F, 0.0F, 5.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(0.0F, -0.45F, -2.5F, 1.1345F, 0.0F, 0.0F));

        body.addOrReplaceChild("collar_back", CubeListBuilder.create()
                        .texOffs(-8, 44).addBox(-4.5F, 0.0F, 0.0F, 9.0F, 0.0F, 8.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(0.0F, -0.45F, 3.5F, -1.5708F, 0.0F, 0.0F));

        body.addOrReplaceChild("cross_a", CubeListBuilder.create()
                        .texOffs(18, 45).addBox(-2.5F, -44.0F, 2.0F, 5.0F, 6.0F, 0.0F, CubeDeformation.NONE),
        ...
        body.addOrReplaceChild("chest_core", CubeListBuilder.create()
                        .texOffs(61, 0).addBox(-1.0F, -1.2974F, -0.1F, 2.0F, 3.0F, 1.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(0.0F, 2.5F, -3.6F, -0.3491F, 0.0F, 0.0F));

        body.addOrReplaceChild("chest_pec_right", CubeListBuilder.create()
                        .texOffs(108, 10).addBox(-4.0F, -3.0F, -3.5F, 4.0F, 4.0F, 4.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(0.5F, 4.0F, -0.5F, -0.3752F, 0.0F, -0.1745F));

        body.addOrReplaceChild("chest_pec_left", CubeListBuilder.create()
                        .texOffs(108, 10).addBox(0.0F, -3.0F, -3.5F, 4.0F, 4.0F, 4.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(-0.5F, 4.0F, -0.5F, -0.3752F, 0.0F, 0.1745F));

        body.addOrReplaceChild("abs", CubeListBuilder.create()
                        .texOffs(38, 21).addBox(-3.5F, -1.0F, 0.3F, 7.0F, 8.0F, 1.0F, CubeDeformation.NONE),
                PartPose.offsetAndRotation(0.0F, 4.7F, -3.3F, 0.0873F, 0.0F, 0.0F));

        PartDefinition rightArm = root.addOrReplaceChild("right_arm", CubeListBuilder.create()
                        .texOffs(112, 48).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F))
                        .texOffs(0, 26).addBox(-2.5F, -2.5F, -2.5F, 4.0F, 13.0F, 5.0F, new CubeDeformation(-0.2F)),
        ...
        rightArm.addOrReplaceChild("right_shoulder", CubeListBuilder.create()
                        ...
                        .texOffs(18, 16).addBox(-3.0F, -6.0F, -3.0F, 4.0F, 9.0F, 6.0F, new CubeDeformation(-0.2F)),
                PartPose.offsetAndRotation(-1.25F, -0.75F, 0.0F, 0.0F, 0.0F, -0.1745F));

        PartDefinition leftArm = root.addOrReplaceChild("left_arm", CubeListBuilder.create().mirror()
                        .texOffs(112, 48).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F))
                        .texOffs(0, 26).addBox(-1.5F, -2.5F, -2.5F, 4.0F, 13.0F, 5.0F, new CubeDeformation(-0.2F)),
                PartPose.offset(5.0F, 2.0F, 0.0F));
        leftArm.addOrReplaceChild("left_shoulder", CubeListBuilder.create().mirror()
                        .texOffs(112, 0).addBox(-1.25F, -2.0F, -2.5F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.05F))
                        .texOffs(25, 0).addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 1.0F, CubeDeformation.NONE)
                        .texOffs(18, 16).addBox(-1.0F, -6.0F, -3.0F, 4.0F, 9.0F, 6.0F, new CubeDeformation(-0.2F)),
                PartPose.offsetAndRotation(1.25F, -0.75F, 0.0F, 0.0F, 0.0F, 0.1745F));
