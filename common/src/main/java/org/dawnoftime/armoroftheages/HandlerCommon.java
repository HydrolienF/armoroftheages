...
// // builder -> builder.icon(() -> new ItemStack(DoTAWItemsRegistry.GENERAL.get()))
...
// @SubscribeEvent
// public static void setDotTab(BuildCreativeModeTabContentsEvent event) { DOT_SELECTED = event.getTab() == DOT_TAB; }

// public static boolean isDotSelected() { return DOT_SELECTED; }
// }
